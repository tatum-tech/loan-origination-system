...
let url = '/decision/api/standard_strategies/:id/segments/requirements/:index?method=editSegment';
              ...
              formElements: [
                {
                  ...
                  value: {
                    component: 'p',
                    children: 'This module passes if all rules pass. If any rule fails, the corresponding Decline Reason will be recorded.',
                    props: {
                      style: {
                        fontStyle: 'italic',
                ...
                }, 
                {
                  ...
                  value: addRuleDropdown([{
                    name: 'CREATE NEW',
                    onclickProps: {
                      title: 'Create New Requirements Rule',
                      pathname: '/decision/strategies/:id/requirements/create/init',
                      params: [{ key: ':id', val: '_id', },],
                    },
                  }, {
                    name: 'COPY EXISTING',
                    onclickProps: {
                      title: 'Copy Existing Requirements Set',
                      pathname: '/decision/strategies/:id/requirements/copy',
                      params: [{ key: ':id', val: '_id', }, ],
                    },
                  }, {
                    name: 'UPLOAD CSV',
                    onclickProps: {
                      title: 'Upload Requirements Segment',
                      pathname: '/modal/decision/upload_csv_segment/requirements',
                      params: [{ key: ':id', val: '_id', },],
                    },
                    passProps: {
                      style: {
