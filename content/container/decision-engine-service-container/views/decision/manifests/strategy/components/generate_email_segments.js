...
let url = `/decision/api/standard_strategies/:id/segments/email/:index?method=editSegment`;
            ...
            formElements: [
              {
                ...
                value: {
                  component: 'p',
                  children: 'This module sends an email based on the below configuration.',
                  props: {
                    style: {
                      fontStyle: 'italic',
              ...
              },
              {
                ...
                value: {
                  ...
                  props: {
                    ...
                    onclickProps: {
                      ...
                      pathname: `/decision/rules/email/:id`,
                      params: [ {
                        key: ':id',
                        val: 'default_rule_id',
                      }]
                ...
                label: 'Send this email to a specific population',
                passProps: {
